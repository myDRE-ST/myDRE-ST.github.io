...
function addVM() {
    ...
    var vm_section =    `<div id="vm-`+running_id+`" class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="card-body">
                            ...
                            <select id="vm-`+running_id+`-type" class="custom-select" onchange="setVMCosts(this);setVMDetails(this);setBottomline();">
                            `+dd_options+`
                            </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <span id="vm-`+running_id+`-Cores"></span> CPU cores
                            <br>
...
function copyVM(val) {
    ...
    var vm_section = `<div id="vm-`+running_id+`" class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="card-header">VM `+running_id+`
                            <div class="btn-group float-right" role="group" aria-label="Basic example">
                            <button class="btn btn-danger" value="`+running_id+`" tabindex="0" data-toggle="tooltip" data-placement="left" title="Delete this VM" onclick="deleteVM(this.value);setBottomline();"> <i class="fa fa-trash"></i></button>
                            <button class="btn btn-outline-secondary" value="`+running_id+`" tabindex="0" data-toggle="tooltip" data-placement="right" title="Copy this VM configuration" onclick="copyVM(this.value)"> <i class="fa fa-copy"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            <label for="vm-`+running_id+`-type">VM Type</label>
...
function setVMCosts(inputObject) {
    ...
    if (typeVal.length !== 0 && hoursVal.length !== 0 && hoursVal >= 0) { // if neither input is empty and hours is positive
